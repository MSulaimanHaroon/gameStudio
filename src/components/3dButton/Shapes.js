...
export function Lights() {
  return (
    <>
      <spotLight color="#fb6161" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#fb6161" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#fb6161" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#f27c05" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#f27c05" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#db1507" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
